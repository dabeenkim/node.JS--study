...
app.get("/set-cookie", (req, res) => {
  ...
  app.get("/get-cookie", (req, res) => {
    ...
    const cookies = req.cookies; //cookieparser 미들웨어를 적용했기 때문에 사용가능
  ...
  app.get('/set-session', (req,res) => {
    const name = "sparta"  //세션의 저장 데이터
    const uniqueInt = Date.now();  //클라이언트에게 할당한 열쇠가 저장
...
app.listen(5002, () => {
    console.log(5002, "포트로 서버가 연결되었습니다.")
})